...
BACKUP="$BACKUP_DIR/notion_log_entry_$(date +%Y%m%d_%H%M%S).py"
...
echo "  - Локальное логирование в ~/.wz_logs/notion_log.ndjson"
echo "  - Mock-ответы в ~/.wz_logs/notion_mock_responses.ndjson"
